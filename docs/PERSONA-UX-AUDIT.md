...
4. **P1 — professional substrate:** build on shipped blend modes, editable
   per-layer adjustments, stroke stabilization and masks; continue with effect
   stacks and color foundations, then vector paths, typography, grids/constraints and linked reusable systems—
