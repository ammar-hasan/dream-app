...
| Sara, 15      | Earn trust and income: create a distinctive logo quickly, revise it from client feedback, keep typography/colors precise, and deliver every professional file without embarrassment.              | Selection/layout, components, layers, named colors with normal-text contrast guidance, honest SVG and one-click multi-size brand pack.                   | No vector-node editing, typography depth, transparent-background workflow, grids, linked color variables, variants, PDF/print/CMYK delivery or client-review loop.                                            |   5.5 |
...
| Aleksandr, 25 | Move at professional thought speed: direct manipulation, precise inspectors, reusable systems, responsive layout, powerful shortcuts, extensibility and polished handoff without tool friction.   | Predictive pointer/drag states and previews, keyboard workflows, snapping/alignment, groups/components, layers, named project colors and batch delivery. | No vector paths, auto layout/constraints, linked variables/tokens, linked components/variants, grids/rulers, multi-page organization, extensibility or inspector depth.                                       |   4.0 |
