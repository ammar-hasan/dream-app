...
| ------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----: |
| Zainab, 5     | Feel creative and powerful without reading or adult help: talk naturally, see a safe delightful story with consistent characters, change it, play it immediately, and recover every accident.     | Little Dreamer, visible listening/transcript, reviewed voice story, basic spoken object corrections, starters, four games, one-step Undo.              | Voice is still command-shaped and browser recognition remains optional; typed fallback does not solve pre-literacy; the offline painter lacks arbitrary fidelity and no child-safety/guardian controls exist. |   5.5 |
...
6. **Voice is visible and repairable, but is not yet conversational.** The
   ...
   “again” safely continues a nudge. Typed recovery still assumes literacy;
   relationships between objects, broader multi-turn clarification and repair,
   and offline recognition are not present.
