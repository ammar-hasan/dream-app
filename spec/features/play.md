...
**Casting is the magic:** your own drawings become the game pieces. Three
templates ship: **Catch!**, **Flappy Dream** and **Maze Runner**.
...
4. The **game-over / win card** shows the score, the project's best, a
   "New best!" tag when beaten (Catch!/Flappy), and a big "Play again!".
5. The **best score persists per project** on the device (one shared best
   slot: Catch! and Flappy record score; Maze Runner records the level
   reached). It does not travel with `.dream` exports.
...
| Knob | Range | Catch! adult / kid | Flappy adult / kid |
|---|---|---|---|
| Speed (`fallSpeed`, px/s) | 60–400 | 180 / 110 | 170 / 120 ("Flight speed") |
| Spawn (`spawnInterval`, s) | 0.4–2.5 | 1.1 / 1.6 | 1.35 / 1.8 ("How often gates come") |
| Lives (`lives`) | 1–9 | 3 / 5 | 1 / 3 ("Shields") |
...
| good catch | 880 Hz · 0.12 s · sine |
| bad catch / Flappy hit | 160 Hz · 0.25 s · sawtooth |
| game over | 220 Hz · 0.5 s · triangle |
| flap | 620 Hz · 0.07 s · square |
| gate threaded | 990 Hz · 0.14 s · sine |
| maze solved | 660 Hz · 0.45 s · triangle |
