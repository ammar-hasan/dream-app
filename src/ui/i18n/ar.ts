...
export const ar: Record<string, string> = {
  ...
  'options.projectColors': 'ألوان المشروع',
  'options.projectColorsCount': '{count}/{max}',
  'options.projectColorSave': 'حفظ الحالي',
  'options.projectColorDefault': 'لون {count}',
  'options.projectColorUse': 'استخدم {name}',
  'options.projectColorRename': 'غيّر اسم {name}',
  'options.projectColorChange': 'غيّر {name}',
  'options.projectColorDelete': 'احذف {name}',
  'options.projectColorLink': 'ربط',
  'options.projectColorLinked': 'مربوط',
  'options.projectColorLinkHint': 'اربط التحديد بـ {name}',
  'options.projectColorUnlinkHint': 'افصل التحديد عن {name}',
  ...
  'layers.blendMode': 'المزج',
  'layers.blend.normal': 'عادي',
  'layers.blend.multiply': 'ضرب',
  'layers.blend.screen': 'شاشة',
  'layers.blend.overlay': 'تراكب',
  'layers.blend.darken': 'تغميق',
  'layers.blend.lighten': 'تفتيح',
  ...
  'voice.stabilizationOn': 'تم تثبيت الخط!',
  'voice.stabilizationOff': 'عاد الخط طبيعياً.',
  ...
  'voice.help':
    'يمكنك أن تقول: فرشاة، قلم، رش، ممحاة، تعبئة، عصا سحرية، طابع، لون مثل أحمر أو أزرق، أكبر، أصغر، ثبّت الخط، خط طبيعي، حرّك هذا، حرّك هذا لليسار، مرة أخرى، ضع هذا في المنتصف، ضع هذا عند الحافة العلوية، احذف هذا، انسخ هذا، فعّل التناظر، أوقف التناظر، تراجع، إعادة، امسح، إطار جديد، شغّل، العب لعبتي، عاين تطبيقي، صدّر تطبيقي، صدّر كودًا حقيقيًا، سجّل صوتي، أوقف التسجيل، امسح الصوت، أوقف، احفظ، مساعدة.',
