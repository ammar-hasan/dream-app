...
export const ar: Record<string, string> = {
  ...
  'voice.help':
    'يمكنك أن تقول: فرشاة، قلم، رش، ممحاة، تعبئة، عصا سحرية، طابع، لون مثل أحمر أو أزرق، أكبر، أصغر، فعّل التناظر، أوقف التناظر، تراجع، إعادة، امسح، إطار جديد، شغّل، العب لعبتي، عاين تطبيقي، صدّر تطبيقي، أوقف، احفظ، مساعدة.',
