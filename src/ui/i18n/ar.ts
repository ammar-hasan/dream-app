...
export const ar: Record<string, string> = {
  ...
  'voice.help':
    'يمكنك أن تقول: فرشاة، قلم، رش، ممحاة، تعبئة، عصا سحرية، طابع، لون مثل أحمر أو أزرق، أكبر، أصغر، حرّك هذا لليسار، ضع هذا في المنتصف، احذف هذا، انسخ هذا، فعّل التناظر، أوقف التناظر، تراجع، إعادة، امسح، إطار جديد، شغّل، العب لعبتي، عاين تطبيقي، صدّر تطبيقي، صدّر كودًا حقيقيًا، سجّل صوتي، أوقف التسجيل، امسح الصوت، أوقف، احفظ، مساعدة.',
