...
| Tool                         | What it does                                                                                                                                                         |
| ---------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `dream.read_project`         | Summary of a `.dream` file: size, background, named project colors with normal-text contrast guidance, mode, layer/frame counts, hotspots, op counts and game setup. |
